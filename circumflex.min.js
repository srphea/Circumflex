...
cf.Matrix3.prototype.Apply=function(a){if(a){var b=this.data;a.transform(b[0],b[1],b[3],b[4],b[6],b[7])}};cf.Matrix3.Transformation=function(a,b,c,d,e,f,h,g,j){g%180==90&&(g=0);j%180==90&&(j=0);var e=e*3.141592654/180,k=Math.cos(e),l=Math.sin(e),e=f*k;k*=h;f=f*l+Math.tan(g*3.141592654/180);h=h*l+Math.tan(j*3.141592654/180);return new cf.Matrix3(e,h,-a*e-b*h+c,-f,k,a*f-b*k+d,0,0,1)};
...
cf.Window=function(a,b,c){function d(){for(var a=e,b=0,c=0;a;)c+=a.offsetTop,b+=a.offsetLeft,a=a.offsetParent;f=b;h=c}var e=this._canvas,f=0,h=0,g=this;if(typeof b!="number")b=a.clientWidth;if(typeof c!="number")c=a.clientHeight;this.Width=e.width=b;this.Height=e.height=c;this.FrameCount=0;this.DesiredFrameTime=1E3/60;this.Loop=!0;this.MouseY=this.MouseX=0;this.MousePressed=!1;this.KeyCode=this.Key=this.PMouseY=this.PMouseX=void 0;this.KeysDown={};this._actualFrameTime=0;window.addEventListener("resize",
d,!1);e.addEventListener("mouseover",this.MouseOver,!1);e.addEventListener("mouseout",this.MouseOut,!1);e.addEventListener("mousemove",function(a){var b=a.pageX-f,a=a.pageY-h;g.PMouseX==void 0?(g.PMouseX=b,g.PMouseY=a):(g.PMouseX=g.MouseX,g.PMouseY=g.MouseY);g.MouseX=b;g.MouseY=a},!1);e.addEventListener("mousemove",this.MouseMove,!1);e.addEventListener("mousedown",function(){g.MousePressed=!0;g.MouseDown();e.addEventListener("mousemove",this.MouseDrag,!1);e.removeEventListener("mousemove",this.MouseMove,
!1)},!1);e.addEventListener("mouseup",function(){g.MousePressed=!1;g.MouseUp();e.removeEventListener("mousemove",this.MouseDrag,!1);e.addEventListener("mousemove",this.MouseMove,!1)},!1);window.addEventListener("keydown",function(a){a=a.keyCode;g.Key=String.fromCharCode(a);g.KeyCode=a;g.KeysDown[a]=!0;g.KeyDown()},!0);window.addEventListener("keyup",function(a){a=a.keyCode;g.Key=String.fromCharCode(a);g.KeyCode=a;g.KeysDown[a]=!1;g.KeyUp()},!0);a.appendChild(e);d();var j=function(){return window.requestAnimationFrame||
window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,g._actualFrameTime)}}(),k=function(){g.FrameCount++;var a=(new Date).getTime();g.Display();a=(new Date).getTime()-a;g._actualFrameTime=a>g.DesiredFrameTime?a:g.DesiredFrameTime;g.Loop&&j(k)};k()};cf.Window.prototype=new cf.RenderTarget(0,0);cf.Window.prototype.GetFPS=function(){return 1E3/this._actualFrameTime};
cf.Window.prototype.MouseOver=function(){};cf.Window.prototype.MouseOut=function(){};cf.Window.prototype.MouseDown=function(){};cf.Window.prototype.MouseUp=function(){};cf.Window.prototype.MouseMove=function(){};cf.Window.prototype.MouseDrag=function(){};cf.Window.prototype.KeyDown=function(){};cf.Window.prototype.KeyUp=function(){};cf.Window.prototype.Display=function(){};
...
cf.Sprite=function(a,b,c,d,e,f,h,g){this._subrect=new cf.Rect;this._transformedRect=new cf.Rect;this._transformedRectUpdated=!1;this._image=null;this.SetImage(a);this.SetPosition(b||0,c||0);this.SetScale(d||1,e||1);this.SetRotation(f||0);this.SetSkew(h||0,g||0)};cf.Sprite.prototype=new cf.Drawable;cf.Sprite.prototype._transformed=function(){this._transformedRectUpdated=!1};
...
cf.Text=function(a,b,c,d,e,f,h,g,j,k){this._string=a||"";this._font=c||"sans-serif";this._fontSize=b||16;this._stroke=!1;this._strokeWidth=1;this._rect=new cf.Rect;this._rectUpdated=!1;this._transformedRect=new cf.Rect;this._transformedRectUpdated=!1;this.Fill=!0;this.Color="#000";this.LineCap="butt";this.LineJoin="mitter";this.StrokeColor="#000";this.FillOverStroke=!1;this.Style="";this._offsetY=this._offsetX=0;this.SetPosition(d||0,e||0);this.SetScale(f||1,h||1);this.SetSkew(j||0,k||0);this.SetRotation(g||
...
cf.ResLoader.prototype.GetPercent=function(){return this._percent};cf.ResLoader.prototype.Add=function(a,b){1 in arguments?this._res.push({url:a,type:b}):this._res.push(a)};
cf.ResLoader.prototype.Start=function(){if(this._res.length){this._cbcalled=!1;this._started=!0;this._percent=this._loaded=0;this._total=this._res.length;for(var a=this,b=function(){a._touching&&setInterval(this,10);a._touching=!0;a._loaded++;a._percent=a._loaded/a._total;a._touching=!1},c;c=this._res.shift();)if(typeof c=="object"){var d=document.createElement(c.type);d.src=c.url;c.type=="img"?d.addEventListener("load",b,!1):d.addEventListener("canplay",b,!1)}else typeof c=="string"&&cf.Ajax.Get(c,
function(a){b();a.status!=200&&alert(c+" couldn't be loaded and is ignored, the application may not function properly")})}};cf.ResLoader.prototype.Loading=function(a){if(this._cbcalled==!0)return!1;return this._percent===1?(a&&a(),this._cbcalled=!0,!1):(this._started||this.Start(),!0)};cf.Gradiant=function(){};